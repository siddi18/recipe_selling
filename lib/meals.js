...
export async function saveMeal(meal) {
    ...
    const stream = fs.createWriteStream(`public/images/${fileName}`); // Create path for image
    ...
    meal.image = `/images/${fileName}`; // Update image path
    console.log('mela.image from savemeal:',meal.image);
